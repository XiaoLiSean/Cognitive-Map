...
if __name__ == '__main__':
    ...
    for obj_sorted in furnitures_sorted:    # Disable small objects
        ...
        if not successfully_placed[obj_sorted['name']]:
            ...
            if event.metadata['lastActionSuccess']:
                ...
                print(obj_sorted['name'],' : ',possible_pRs)
    ...
    for obj in furnitures:
        print(obj['name'], obj['parentReceptacles'] )
    ...
    controller.step(action='InitialRandomSpawn', randomSeed=1, forceVisible=False, numPlacementAttempts=num_attempts, placeStationary=True)
    print(successfully_placed)
    # event = controller.step(action='RotateLeft', degrees=90.0)
    time.sleep(5)
    # event = controller.step(action='RotateLeft', degrees=90.0)
