...
NODES = {'FloorPlan26': [[-2.00, 3.75], [-1.25, 3.75], [-2.00, 3.00], [-1.25, 3.00],
         ...
         'FloorPlan226': [[-2.50, -1.00], [-1.75, -1.00], [-1.75, -0.25], [-1.75, 0.50], [-2.50, -0.25], 
                          [-0.75, 0.25], [0.25, 0.25], [1.25, 0.25], [1.25, 0.75], [0.25, 0.75], [0.75, -0.50],
                          [0.25, -0.50], [0.75, -1.25], [1.75, -1.25], [1.25, -2.00], [0.75, -2.00], [-1.75, -1.75],
                          [-0.75, -1.00], [0.00, -1.00], [-0.75, 0.50], [-0.75, -1.25]],
         'FloorPlan227': [[-5.75, 0.75], [-6.75, 0.75], [-6.75, 1.75], [-6.75, 3.25], [-6.75, 4.25], [-6.75, 4.75],
                          [-5.75, 4.25], [-4.75, 3.50], [-4.75, 2.00], [-4.75, 0.75], [-3.50, 2.00], [-3.50, 0.75],
                          [-3.50, 3.00], [-2.75, 2.75], [-2.50, 0.75], [-1.50, 0.75], [-1.75, 1.75], [-0.50, 0.75],
                          [-0.25, 2.50], [-0.25, 3.25], [-0.25, 4.25], [-1.25, 4.25], [-2.25, 4.25], [-3.25, 4.25],
                          [-4.75, 4.25], [-5.75, 4.75], [-4.75, 4.75], [-1.25, 4.75], [-2.25, 4.75], [-3.25, 4.75],
                          [-4.75, 1.25], [-3.50, 1.25], [-2.50, 1.25], [-1.50, 1.25], [-0.75, 3.75], [-4.00, 4.25],
                          [-4.00, 4.75], [-0.25, 1.50], [-0.50, 1.25], [-2.00, 2.50], [-6.75, 2.50], [-4.75, 3.00],
                          [-4.00, 0.75], [-4.00, 1.25], [-4.00, 2.00], [-4.00, 3.00]],
...
#---------------------------
         ...
         'FloorPlan29': [[1.00, 2.25], [1.00, 1.50], [0.25, 2.25], [0.25, 1.50], [1.75, 2.00],
                         ...
                         [-0.50, -0.50], [-1.25, -0.5], [0.5, -0.25], [0.5, -0.75], [1.00, -0.50],
                         [1.5, -0.25], [1.5, -0.75], [-1.25, 1.00], [-0.50, 1.00], [0.00, -0.50]],
         'FloorPlan30': [[2.50, -1.50], [1.75, -1.50], [2.50, -0.50], [2.00, -0.50],
                         ...
                         [1.25, 1.50], [0.50, -1.00], [0.50, -0.50], [0.50, 1.50], [2.00, -1.00]],
          ...
          'FloorPlan229': [[-0.25, 3.00], [-0.25, 2.25], [-1.00, 3.00], [-1.00, 2.25],
                           ...
                           [-4.50, 3.75], [-5.75, 3.25], [-4.00, 1.75], [-3.00, 1.75],
                           [-3.75, 3.25]],
          'FloorPlan230': [[-5.75, 4.25], [-5.75, 3.25], [-5.75, 2.25], [-5.00, 4.25],
           ...
           'FloorPlan330': [[-0.25, 2.00], [-1.00, 2.00], [-1.75, 2.00], [0.5, 2.00],
                            ...
                            [1.75, 1.00], [2.50, 1.00], [2.50, 0.00],
                            [2.50, -1.00], [1.25, 1.50]],

           'FloorPlan429': [[0.25, -0.25], [0.25, -1.25], [0.25, -2.25], [-0.75, -0.25],
                            [-0.75, -1.25], [-0.75, -1.00], [-0.75, -2.25], [-0.75, -3.25],
                            [-1.75, -1.00], [0.25, -2.75], [0.75, -2.75],
                            [0.75, -3.50], [-1.75, -0.50], [-0.25, -0.50], [-0.25, -1.75]],
           'FloorPlan430': [[-1.50, 2.00], [-2.25, 2.00], [-2.25, 1.25], 
                            [-1.50, 1.25], [-1.50, 0.25], [-2.25, 0.25], [-0.50, 0.25],
                            [0.25, 0.25], [-0.50, 1.25], [0.25, 1.25], [0.25, -0.50],
                            [-0.50, -0.50], [-1.50, -0.50], [-0.50, -1.25], [0.00, -1.25], [-1.00, 0.75]]
        }
