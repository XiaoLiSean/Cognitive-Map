...
NODES = {'ChairHallwayTest' : [[1.75, 1.75], [2.00,1.00], [2.00,0.00], [2.00,-1.00], [2.00,-2.00]],
         'FloorPlan26': [[-2.00, 4.00], [-1.00, 4.00], [-2.00, 3.00], [-1.25, 3.00],
         ...
         'FloorPlan227': [[-5.75, 0.75], [-6.75, 0.75], [-6.75, 2.00], [-6.75, 3.25], [-6.75, 4.50],
                          [-5.75, 4.50], [-4.75, 3.25], [-4.75, 2.00], [-4.75, 0.75], [-3.50, 2.00], [-3.50, 0.75],
                          [-3.50, 3.00], [-2.25, 2.75], [-2.50, 0.75], [-1.50, 0.75], [-1.75, 1.75], [-0.25, 0.75],
                          [-0.25, 2.00], [-0.25, 3.25], [-0.25, 4.25], [-1.25, 4.50], [-2.25, 4.50], [-3.25, 4.50],
                          [-4.50, 4.50]],
         'FloorPlan228': [[-4.75, 3.75], [-3.75, 3.75], [-2.75, 3.75], [-1.50, 3.75], [-0.50, 3.75], [-1.50, 4.75],
                          [-4.75, 2.75], [-4.75, 1.50], [-3.50, 1.50], [-2.75, 1.50], [-2.75, 2.75], [-1.50, 2.75],
                          [-0.50, 2.25]],
         'FloorPlan326': [[0.50, -0.25], [0.50, -1.00], [0.50, -2.25], [-0.50, -2.25], [-1.50, -2.25], [-2.50, -2.25],
                          [-1.50, -1.50], [-1.50, -0.75], [-1.50, 0.00], [1.25, -1.00], [1.25, -0.25], [2.00, -0.25],
                          [2.00, -1.00], [2.00, -2.00], [2.50, -2.75]],
         'FloorPlan327': [[-0.75, -2.00], [-0.25, -1.50], [-0.25, -0.50], [-0.25, 0.50], [-0.25, 1.50], [-1.25, 1.50],
                          [0.50, 1.50], [0.5, 0.50], [0.5, -0.50], [0.5, -1.50]],
         'FloorPlan426': [[-0.50, 1.75], [-1.25, 1.75], [-1.25, 2.75], [-0.50, 1.00], [-1.75, 1.50], [-1.75, 1.00],
                          [-2.75, 1.00]],
         'FloorPlan427': [[-2.75, 1.25], [-2.75, 0.25], [-1.75, 1.25], [-1.75, 0.25], [-0.75, 1.25], [-0.75, 0.25]],
         'FloorPlan428': [[0.75, 3.50], [-0.25, 3.50], [-1.25, 3.50], [-1.25, 2.50], [0.00, 2.50], [0.00, 1.50], [-1.00, 1.50]],
#---------------------------
         ...
         'FloorPlan30': [[2.50, -1.50], [1.75, -1.50], [2.50, -0.50], [2.00, -0.50],
          ...
          'FloorPlan230': [[-5.75, 4.25], [-5.75, 3.25], [-5.75, 2.25], [-5.00, 4.25],
           ...
           'FloorPlan430': [[-1.50, 2.00], [-2.25, 2.00], [-2.25, 1.25], [-1.50, 1.25],
            ...
            'FloorPlan600' : [[1.75, -1.5], [1.75, -0.5], [1.75,0.5], [1.75,1.75],
                                  [1.00, 2.00], [0.00, 2.00], [-1.00, 2.00], [-1.00, 1.0], [-1.00, 0.00],
                                  [-1.00, -1.00], [-0.75, -1.5], [0.5, -1.5]],

            'FloorPlan602' : [[1.75, -1.5], [1.75, -0.5], [1.75,0.5], [1.75,1.75],
                                  [1.00, 2.00], [0.00, 2.00], [-1.00, 2.00], [-1.00, 1.0], [-1.00, 0.00],
                                  [-1.00, -0.75], [-0.75, -1.5], [0.0, -1.5], [1.0,-1.5]],
            'FloorPlan603' : [[1.75, -1.5], [1.75, -0.5], [1.75,0.5], [1.75,1.75],
                                  [1.00, 2.00], [0.00, 2.00], [-1.00, 2.00], [-1.00, 1.0], [-1.00, 0.00],
                                  [-1.00, -0.75], [-0.75, -1.5], [0.0, -1.5], [1.0,-1.5]],

            'FloorPlan604' : [[1.75, -1.5], [1.75, -0.5], [1.75,0.5], [1.75,1.75],
                                  [1.00, 2.00], [0.00, 2.00], [-1.00, 2.00], [-1.00, 1.0], [-1.00, 0.00],
                                  [-1.00, -0.75], [-0.75, -1.5], [0.0, -1.5], [1.0,-1.5]]
                    }
...
CONSTRAINTS = { 'ChairHallwayTest' : [[[0,1], [0.75, 2.0, 0.5]],[[1,2], [1.5, 2.0, 0.5]],
                [[2,3], [1.25, 2.0, 0.5]], [[3,4], [0.25, 2.0, 0.5]]],
                'FloorPlan600' : [[[0,1], [1.00, 2.0, 1.0]], [[1,2], [2.00, 2.00, 1.00]], [[2,3], [2.00, 2.00, 1.00]],
                                  [[3,4], [1.00, 2.00, 1.00]], [[4,5], [1.00, 2.00, 1.00]]],
                'FloorPlan602': [[[2,3], [2.00, 2.00, 2.00]]],
                'FloorPlan603': [[[2,3], [1.50, 0.75, 0.75]]],
                'FloorPlan604': [[[2,3], [1.5, 0.75, 0.75]]]
                }
